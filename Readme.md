...
* дополняем инструкцию по работе с удалёнными и локальными репозиториями и их взаимодействиями между собой.
...
## Скачивание изменений с удаленного репозитория
  ...
  в терминале с папкой репозитория, связанным с уаденным репозиторием пишем git pull ogigin название ветки для того чтобы принять измнеенния  из указанной ветки удаленного репозитория
...
При необходимости присоединиться к группе, работающей в удалённом репозитории, и создании в таком уже существующем репозитории своих доработок, необходимо создать копию (клон) этого репозитория на своём локальном компьютере. Для этого применяется программа git clone ссылка-на-клонируемый-репозиторий
